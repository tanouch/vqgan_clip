...
##################################
##################################
def generate_image_with_VQGAN_CLIP(
    prompts=None,
    image_prompts=None,
    noise_prompt_seeds=[],
    ...
    init_weight=0.,
    clip_model='ViT-B/32',
    vqgan_config='/home/u.tanielian/sync/product_gen/multi-modal-training/taming_models/vqgan_imagenet_f16_16384_configs.yaml',
    vqgan_checkpoint='/home/u.tanielian/sync/product_gen/multi-modal-training/taming_models/vqgan_imagenet_f16_16384.ckpt',
    step_size=0.05,
    cutn=128,
    cut_pow=1.,
    display_freq=100,
...
if __name__ == "__main__":
    fire.Fire(generate_image_with_VQGAN_CLIP)